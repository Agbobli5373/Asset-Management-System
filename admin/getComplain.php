                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                        <a role="button" type="button" class="btn btn-outline-success btn-sm btn-edit" href="<?php echo 'viewComplain.php?id=' . $get_comaplain_Id; ?>" id="<?php echo $get_user_Id  ?>">View</a><!--<button type="button" class="btn btn-outline-danger btn-sm btn-delete" id="<?php echo $get_user_Id  ?>">Delete</button>
                                                -->
                                                        </td>
