                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="header-title mb-4">Department Assert</h4>
                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-centered table-nowrap mb-0 table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                $getAssets = mysqli_query($connectionString, "SELECT * FROM asset_tbl 
                                                                            ...
                                                                            JOIN department_tbl on asset_tbl.department_id = department_tbl.department_id 
                                                                            WHERE asset_tbl.department_id = $user_dp") or die(mysqli_error($connectionString));
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button role="button" type="button" class="btn btn-outline-success btn-sm btn-edit"  id="<?php echo $get_asset_Id  ?>">Complain</a>
                                                                           </td>
